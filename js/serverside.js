...
function recompose_block(server_block){
  ...
  var block = new CodeBlock(server_block.name, parentRef.palette_id, parentRef.modal_id, parentRef.action, parentRef.events.on_open_modal, parentRef.events.on_close_modal, parentRef.events.on_draw_parameters,server_block.parameters, server_block.multi_block);
